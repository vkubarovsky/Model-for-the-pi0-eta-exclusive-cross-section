C======================================================
      SUBROUTINE DVMPX_PAW(MESONMASS)
      IMPLICIT NONE
      REAL MESONMASS
      INTEGER K
      COMMON/PIETA/K
...
C -------  pi0 fit parameters and errors
c VE/INPUT P    6.2064  0.8020 -0.1068  1.8357  0.0000 94.6330  3.4431 -1.9768 -0.1311  0.0000 17.0005  2.1243
c VE/INPUT SP   0.1043  0.0107  0.0183  0.0368  0.0000  1.7092  0.0346  0.0344  0.0589  0.0000  1.5124  0.1851
 
C ------- eta fit parameters and errors
c VE/INPUT P    6.8866  1.7875 -1.3202  0.7792  0.0000 17.7482  1.1437  0.0071  1.5875  0.0000 21.3261  3.9052
c VE/INPUT SP   0.2643  0.0239  0.0230  0.1273  0.0000  1.5024  0.0284  0.0664  0.3122  0.0000  5.2688  0.8199
...
C
C---------------------------------------------------------------------------------------------------
C       KUMAC file: fitxs.kumac, fit cross sections (t,xB,Q2,phi).
C
...
C      HT=P1*EXP(-SLOPE*T) * Q2**(P4/2.)*W2**P5
...
C====================================================================================c
      ...
      SLOPE=P2+P3*(ALOG(X)-ALOG(0.15))
      W2=Q2*(1./X-1.)+0.93827**2
C      ET=P1*EXP(-SLOPE*T) * Q2**(P4/2.)*W2**P5
...
C      PRINT *,'HTEBAR= ',HTEBAR,' SLOPE=',slope
c      print *,'P11 ',p11,p12
      RETURN
      END
C====================================================================================c
...
C====================================================================================c
       ...
       DATA MP/0.938272/
       DATA HC2/389379.36/
C       print *, del2,x,Q2,E,XCHECK_KINE(del2,x,Q2,E)
       IF(XCHECK_KINE(del2,x,Q2,E)) THEN
       T0=tminq(Q2,X)
       T=-DEL2
       KSI=X/(2-X)*(1+MP**2/Q2)
...
C      print *,' XSIGMA_LT=', xsigma_lt, t,t0,x,q2
