      ...
      PARAMETER (NT=8)
      PARAMETER (NP=20)
c      PARAMETER (INDMAX=1867)
c      PARAMETER (INDMAX=1245)
...
c      print *,'FITXS ',k,MESONMASS

      IF(K.eq.1) INDMAX=1867
      IF(K.eq.2) INDMAX=1245
...
c      PRINT 100,FITXS,XST,XSTT,EPS,COST2,P
 100  format(
     *     ' XS,XST,XSTT=',3F11.3, ' Eps=',f10.3,' COST2=',F5.3/
     *     ' HT=',5f8.2,'  ET=',5F8.2) 
      RETURN
      END
C======================================================
